...
print('f1 score 0\'s: {:.2f}'.format(100*f1_score(dev_y, pred_y, pos_label=0)))
print('recall 0\'s: {:.2f}'.format(100*recall_score(dev_y, pred_y, pos_label = 0)))
print('precision 0\'s: {:.2f}'.format(100*precision_score(dev_y, pred_y, pos_label = 0)))
