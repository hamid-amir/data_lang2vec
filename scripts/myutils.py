...
def extract_features(classifier: Literal['find_missing', 'find_value'], n_components:int = 10, miltate_n_components: int = 10, dimension_reduction_method: str = 'pca', n: int = None, remove_features: list = [], miltale_data: bool = False):
    '''
